...
ra.hist.prec<-"nora10_PREC1d_hist_2014_f61.dat"
ob.hist.prec<-"seNorge2_PREC1d_hist_2014_f61.dat"
# descriptive statistics
ra.output.mode.nc<-"nora10_PREC1d_hist_mode_2014_f61.nc"
ob.output.mode.nc<-"seNorge2_PREC1d_hist_mode_2014_f61.nc"
ra.output.mode.png<-"nora10_PREC1d_hist_mode_2014_f61.png"
ob.output.mode.png<-"seNorge2_PREC1d_hist_mode_2014_f61.png"
# score indexes (netcdf)
score.output.mode.diff.nc<-"nora10_seNorge2_PREC1d_modediff_2014_f61.nc"
score.output.mode.RelErr.nc<-"nora10_seNorge2_PREC1d_moderelerr_2014_f61.nc"
score.output.pdf.nc<-"nora10_seNorge2_PREC1d_pdfoverscore_2014_f61.nc"
score.output.ksD.nc<-"nora10_seNorge2_PREC1d_ksd_2014_f61.nc"
score.output.ksT.nc<-"nora10_seNorge2_PREC1d_kstest_2014_f61.nc"
# score indexes (graphic)
score.output.mode.diff.png<-"nora10_seNorge2_PREC1d_modediff_2014_f61.png"
score.output.mode.RelErr.png<-"nora10_seNorge2_PREC1d_moderelerr_2014_f61.png"
score.output.pdf.png<-"nora10_seNorge2_PREC1d_pdfoverscore_2014_f61.png"
score.output.ksD.png<-"nora10_seNorge2_PREC1d_ksd_2014_f61.png"
score.output.ksT.png<-"nora10_seNorge2_PREC1d_kstest_2014_f61.png"
